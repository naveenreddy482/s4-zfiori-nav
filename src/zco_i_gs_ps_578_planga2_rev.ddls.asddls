...
@EndUserText.label: 'Gasline: Erloese AR on WBS Element'
...
define view entity ZCO_I_GS_PS_578_PLANGA2_REV
  ...
  inner join ZPS_I_BPJA as _BPJA on _BPJA.ObjectNumber = _psp.Objnr
{
  ...
  key _BPJA.FiscalYear,
      ...
      cast(sum(_BPJA.ValueYearTransCurrency) as bp_wgt preserving type ) as ErloeseAR
}
where
      _BPJA.PlanBudgetVersion = 'GA2'
